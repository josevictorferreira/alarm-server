...
class Async::LimitedQueue < ::Async::Queue
  ...
  #
  # source://async//lib/async/queue.rb#163
  def dequeue; end
  ...
  #
  # source://async//lib/async/queue.rb#145
  def enqueue(*items); end

  # Returns the value of attribute limit.
  #
  # source://async//lib/async/queue.rb#120
  def limit; end
  ...
  # If the queue is full, this method will block until there is space available.
  #
  # source://async//lib/async/queue.rb#132
  def push(item); end
end
...
class Async::Node
  ...
  # the parent.
  #
  # source://async//lib/async/node.rb#228
  def consume; end
  ...
  #
  # source://async//lib/async/node.rb#304
  ...
  #
  # source://async//lib/async/node.rb#283
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/node.rb#296
  def stopped?; end
  ...
  # source://async//lib/async/node.rb#208
  def add_child(child); end

  # source://async//lib/async/node.rb#214
  def remove_child(child); end

  # source://async//lib/async/node.rb#204
  def set_parent(parent); end

  # @yield [_self, level]
  # @yieldparam _self [Async::Node] the object that the method was called on
  #
  # source://async//lib/async/node.rb#259
  ...
  #
  # source://async//lib/async/node.rb#289
...
# source://async//lib/async/scheduler.rb#23
...
class Async::Queue
  ...
  # Remove and return the next item from the queue.
  #
  # source://async//lib/async/queue.rb#60
  def dequeue; end

  # Enumerate each item in the queue.
  #
  # source://async//lib/async/queue.rb#88
  def each; end
  ...
  # Add multiple items to the queue.
  #
  # source://async//lib/async/queue.rb#53
  def enqueue(*items); end
  ...
  #
  # source://async//lib/async/queue.rb#95
  def signal(value = T.unsafe(nil)); end
  ...
  #
  # source://async//lib/async/queue.rb#100
  def wait; end
end
...
class Async::Scheduler < ::Async::Node
  ...
  #
  # source://async//lib/async/scheduler.rb#265
  ...
  #
  # source://async//lib/async/scheduler.rb#124
  def close; end
  ...
  #
  # source://async//lib/async/scheduler.rb#502
  def run(*_arg0, **_arg1, &_arg2); end

  # Run one iteration of the event loop.
  #
  # source://async//lib/async/scheduler.rb#423
  ...
  #
  # source://async//lib/async/scheduler.rb#457
  def stop; end

  # Terminate all child tasks.
  #
  # source://async//lib/async/scheduler.rb#113
  def terminate; end
  ...
  #
  # source://async//lib/async/scheduler.rb#576
  def timeout_after(duration, exception, message, &block); end

  # source://async//lib/async/scheduler.rb#154
  def to_s; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/scheduler.rb#441
  def interrupted?; end

  # source://async//lib/async/scheduler.rb#463
  ...
  #
  # source://async//lib/async/scheduler.rb#379
  def run_once!(timeout = T.unsafe(nil)); end
...
#
# source://async//lib/async/scheduler.rb#33
...
class Async::Task < ::Async::Node
  ...
  #
  # source://async//lib/async/task.rb#112
  def annotate(annotation, &block); end

  # source://async//lib/async/task.rb#121
  def annotation; end
  ...
  # @raise [FinishedError]
  #
  # source://async//lib/async/task.rb#222
  def async(*arguments, **options, &block); end
  ...
  #
  # source://async//lib/async/task.rb#320
  def defer_stop; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#353
  ...
  # source://async//lib/async/task.rb#130
  def to_s; end
  ...
  #
  # source://async//lib/async/task.rb#245
  def wait; end
  ...
  #
  # source://async//lib/async/task.rb#404
  ...
  # source://async//lib/async/task.rb#435
  ...
  # source://async//lib/async/task.rb#377
  ...
  class << self
    ...
    #
    # source://async//lib/async/task.rb#360
    def current; end
...
# @private
#
# source://async//lib/async/worker_pool.rb#12
class Async::WorkerPool
  # Create a new work pool.
  #
  # @return [WorkerPool] a new instance of WorkerPool
  #
  # source://async//lib/async/worker_pool.rb#145
  def initialize(size: T.unsafe(nil)); end

  # Offload work to a thread.
  #
  # source://async//lib/async/worker_pool.rb#168
  def call(work); end

  # Close the work pool. Kills all outstanding work.
  #
  # source://async//lib/async/worker_pool.rb#154
  def close; end
end

# Used to augment the scheduler to add support for blocking operations.
#
# source://async//lib/async/worker_pool.rb#14
module Async::WorkerPool::BlockingOperationWait
  # Wait for the given work to be executed.
  #
  # source://async//lib/async/worker_pool.rb#22
  def blocking_operation_wait(work); end
end

# Execute the given work in a background thread.
#
# source://async//lib/async/worker_pool.rb#28
class Async::WorkerPool::Promise
  # Create a new promise.
  #
  # @return [Promise] a new instance of Promise
  #
  # source://async//lib/async/worker_pool.rb#32
  def initialize(work); end

  # Execute the work and resolve the promise.
  #
  # source://async//lib/async/worker_pool.rb#42
  def call; end

  # Cancel the work and raise an exception in the background thread.
  #
  # source://async//lib/async/worker_pool.rb#77
  def cancel; end

  # Wait for the work to be done.
  #
  # source://async//lib/async/worker_pool.rb#90
  def wait; end

  private

  # source://async//lib/async/worker_pool.rb#66
  def reject(error); end

  # source://async//lib/async/worker_pool.rb#56
  def resolve(value); end
end

# A background worker thread.
#
# source://async//lib/async/worker_pool.rb#106
class Async::WorkerPool::Worker
  # Create a new worker.
  #
  # @return [Worker] a new instance of Worker
  #
  # source://async//lib/async/worker_pool.rb#108
  def initialize; end

  # Call the work and notify the scheduler when it is done.
  #
  # source://async//lib/async/worker_pool.rb#129
  def call(work); end

  # Close the worker thread.
  #
  # source://async//lib/async/worker_pool.rb#121
  def close; end

  # Execute work until the queue is closed.
  #
  # source://async//lib/async/worker_pool.rb#114
  def run; end
end

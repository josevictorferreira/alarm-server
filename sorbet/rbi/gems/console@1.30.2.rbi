...
class Console::Config
  ...
  # @return [Boolean]
  #
  # source://console//lib/console/config.rb#44
...
# Load the default configuration.
#
# source://console//lib/console/config.rb#91
...
class Console::Event::Generic
  ...
  #
  # source://console//lib/console/event/generic.rb#35
  def emit(*arguments, **options); end
...
class Console::Filter
  ...
  # @return [Boolean]
  #
  # source://console//lib/console/filter.rb#162
  ...
  # Set the log level.
  #
  # source://console//lib/console/filter.rb#115
  def level=(level); end
  ...
  #
  # source://console//lib/console/filter.rb#101
  def verbose; end
...
module Console::Output::Default
  class << self
    ...
    #
    # source://console//lib/console/output/default.rb#19
    def new(stream, **options); end
  end
end
...
#
# source://console//lib/console/output/serialized.rb#96
...
class Console::Output::Terminal
  ...
  #
  # source://console//lib/console/output/terminal.rb#71
  def initialize(stream, verbose: T.unsafe(nil), start_at: T.unsafe(nil), format: T.unsafe(nil), **options); end

  # Log a message with the given severity.
  #
  # source://console//lib/console/output/terminal.rb#144
  ...
  #
  # source://console//lib/console/output/terminal.rb#123
  def register_formatters(namespace = T.unsafe(nil)); end

  # Returns the value of attribute start.
  #
  # source://console//lib/console/output/terminal.rb#110
  def start; end
  ...
  #
  # source://console//lib/console/output/terminal.rb#113
  def terminal; end

  # Returns the value of attribute verbose.
  #
  # source://console//lib/console/output/terminal.rb#107
  def verbose; end

  # Set the verbose output.
  #
  # source://console//lib/console/output/terminal.rb#118
  def verbose!(value = T.unsafe(nil)); end
  ...
  # source://console//lib/console/output/terminal.rb#274
  def build_prefix(name); end

  # source://console//lib/console/output/terminal.rb#211
  def default_suffix(object = T.unsafe(nil)); end

  # source://console//lib/console/output/terminal.rb#195
  def format_argument(argument, output); end

  # source://console//lib/console/output/terminal.rb#180
  def format_event(event, buffer, width); end

  # source://console//lib/console/output/terminal.rb#237
  def format_object_subject(severity, prefix, subject, output); end

  # source://console//lib/console/output/terminal.rb#191
  def format_options(options, output); end

  # source://console//lib/console/output/terminal.rb#249
  def format_string_subject(severity, prefix, subject, output); end

  # source://console//lib/console/output/terminal.rb#201
  def format_subject(severity, prefix, subject, buffer); end

  # source://console//lib/console/output/terminal.rb#261
  def format_value(value, output); end

  # source://console//lib/console/output/terminal.rb#270
  ...
  class << self
    ...
    #
    # source://console//lib/console/output/terminal.rb#51
...
#
# source://console//lib/console/output/terminal.rb#296
module Console::Output::XTerm
  class << self
    ...
    #
    # source://console//lib/console/output/terminal.rb#304
    def new(output, **options); end
  end
end
...
class Console::Terminal::Text
  ...
  #
  # source://console//lib/console/terminal/text.rb#16
  ...
  # @return [Boolean]
  #
  # source://console//lib/console/terminal/text.rb#41
  def colors?; end
  ...
  #
  # source://console//lib/console/terminal/text.rb#85
  def puts(*arguments, style: T.unsafe(nil)); end

  # Generate a reset sequence.
  #
  # source://console//lib/console/terminal/text.rb#64
  def reset; end
  ...
  # Returns the value of attribute stream.
  #
  # source://console//lib/console/terminal/text.rb#22
  def stream; end

  # Generate a style string for the given foreground, background, and attributes.
  #
  # source://console//lib/console/terminal/text.rb#58
  def style(foreground, background = T.unsafe(nil), *attributes); end

  # source://console//lib/console/terminal/text.rb#51
  def width; end

  # Write the given arguments to the output stream using the given style. The reset sequence is automatically appended.
  #
  # source://console//lib/console/terminal/text.rb#71
